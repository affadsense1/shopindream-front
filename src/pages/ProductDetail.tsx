            ...
            <div className="flex items-baseline gap-3 py-4">
              ...
              {hasDiscount && (
                <>
                  ...
                  <Badge variant="secondary" className="bg-accent text-accent-foreground text-base px-3 py-1">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              <div className="flex gap-0.5">
                                ...
                                <Star
                                    key={i}
                                    className={`w-5 h-5 ${
                                      i < adjustedScore ? "fill-amber-400 text-amber-400" : "fill-gray-300 text-gray-300 dark:fill-gray-600 dark:text-gray-600"
                                    }`}
                                  />
                                ))}
                              </div>
