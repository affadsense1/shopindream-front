...
### 接口地址
```
POST https://api.shopindream.shop/public/api/cart/cart.php
```
...
### 接口地址
```
POST https://api.shopindream.shop/public/api/cart/checkout.php
```
...
#### 接口地址
```
POST https://api.shopindream.shop/public/api/user/reg.php
```
...
#### 接口地址
```
POST https://api.shopindream.shop/public/api/user/login.php
```
